...
export default function TransactionsTable({ transactions, filters, setFilters }: any) {
    ...
    return (
        <div
            className="overflow-x-auto rounded-xl border shadow-sm transition-colors duration-300"
            style={{
                    ...
                    {[
                        ...
                        <th
                            ...
                            className={`p-3 select-none ${
                                ["date", "price", "amount"].includes(col.key)
                                    ? "cursor-pointer"
                                    : ""
                            }`}
                            onClick={() =>
                                ["date", "price", "amount"].includes(col.key) && handleSort(col.key)
                            }
                        >
                ...
                {transactions.length === 0 ? (
                    ...
                    transactions.map((tx: any) => (
                        ...
                        >
                            ...
                            <td className="p-3">${tx.total.toFixed(2)}</td>
                            <td
